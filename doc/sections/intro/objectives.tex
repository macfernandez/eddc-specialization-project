...
\begin{itemize}
    ...
    \item{Utilizar dishcos m\'etodos estad\'isticos para realizar una selecci\'on de
...
\begin{itemize}
    ...
    \cite{monroe2008fightin} para los m\'etodos estad\'isticos se evidencian
    tambi\'en para el caso del español.}
    \item{Evaluar si los rasgos seleccionados permiten entrenar un modelo que,
    dado un discurso, distinga a qu\'e voto podr\'ia llegar a emitir la persona que
    lo pronunci\'o.}
\end{itemize}
