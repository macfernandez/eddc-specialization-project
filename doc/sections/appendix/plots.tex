...
\begin{figure}[!htb]
    \centering
    \includegraphics[scale=0.45]{../visualizations/features/f1_by_split.png}
    \vfill
    \includegraphics[scale=0.45]{../visualizations/features/f1_macro_by_split.png}
    \vfill
    \includegraphics[scale=0.45]{../visualizations/features/f1_weighted_by_split.png}
