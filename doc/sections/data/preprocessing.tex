...
de programaci\'on \textit{Python 3}. En primer lugar, se descarg\'o la transcripci\'on en formato \textit{PDF} y luego, por
...
pre-procesamiento con el fin de limpiar y organizar los datos de forma \'util a los
...
enriquecerla con especificaci\'ones como la filiaci\'on partidaria y la
...
cual, tomando como base los nombres y apellidos en un \textit{dataset}, se explor\'o
exhaustivamente su correspondencia con con aquellos presentes en otro \textit{datset}.
Para esto, se consider\'o cada cadena de nombre/s y apellido/s como un conjunto
y se evalu\'o la existencia de coincidencia
o de relaci\'on de subconjunto entre ambos. En la mayor\'ia de los casos,
