...
y, por otro, se utilizó la Ley de Zipf para definir el conjunto de palabras
consideradas \textit{stopwords} en el universo de estos discursos.
Para esto, se calculó la frecuencia absoluta de aparición de
cada token y, en virtud de esa frecuencia, se estableció \textit{ranking}
ordenando las palabras de manera decreciente según su aparición.
Luego se contrastó diche frecuencia con el orden asignado y se definió
