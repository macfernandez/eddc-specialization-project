...
la sustracci\'on, por lo que:\todo[color=pink]{en resultados, recordar hablar
de lo pol\'emico de este abordaje para}
...
a partir del siguiente c\'alculo:\todo[color=pink]{checkear si es de ellos o de qui\'en}
