...
% PARTICULAR
% - Las observaciones detalladas en el paper se
% evidencian también para el caso del español
...
% Fuente de los datos
% Procedimiento para su obtención (scrapper)
% Preprocesamiento realizado
% - .pdf --> .txt
% - pasaje a formato tabular
% Breve descripción de los datos:
% - cantidad de partidos totales
% - cantidad de oradores totales
% - distribucioón oradores~partidos
